            ...
            <div className="max-w-md mx-auto relative z-20">
              ...
              >
                <div className="mb-10">
                  ...
                  <h1 className="font-belleza text-4xl text-white mb-4 tracking-wide">ЗМІНИТИ ПАРОЛЬ</h1>
                  <p className="text-stone-400 font-light">На вашу пошту прийде лист для змінення пароля.</p>
              ...
              <AnimatePresence mode="wait">
                {wasSended ? (
                  ...
                  >
                    <div className="mb-6">
                      <div className="w-20 h-20 rounded-full bg-olive-900/30 mx-auto flex items-center justify-center mb-6">
                        <Mail className="h-10 w-10 text-olive-400" />
                      </div>
                      <h2 className="font-belleza text-2xl text-white mb-4 text-center">ЛИСТ ВІДПРАВЛЕНО!</h2>
                    ...
                    >
                      <Link
                        href="/login"
                        className="relative w-full bg-olive-800 hover:bg-olive-700 text-white py-4 font-belleza tracking-wider overflow-hidden transition-all duration-300 group flex items-center justify-center"
                      >
                        ...
                        <span className="relative z-10 flex items-center justify-center gap-2">
                          <span className="tracking-[0.15em]">ПОВЕРНУТИСЯ ДО ВХОДУ</span>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-8">
                      ...
                      >
                        ...
                        <span className="relative z-10 flex items-center justify-center gap-2">
                          {formSubmitted ? (
                            ...
                            <>
                              <span className="tracking-[0.15em]">ОТРИМАТИ ЛИСТ</span>
                              <ArrowRight className="h-4 w-4 transform group-hover:translate-x-1 transition-transform duration-300" />
                            </>
                          )}
                        </span>
                    ...
                    >
                      ...
                      >
                        <ChevronLeft className="h-3 w-3 transform group-hover:-translate-x-1 transition-transform duration-300" />
